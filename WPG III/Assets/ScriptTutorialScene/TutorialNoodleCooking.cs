...
public class TutorialNoodleCooking : MonoBehaviour
{
    ...
    private void TryInteract()
    {
        ...
        if (isEmptyPot && !isCooking && !isCooked)
        {
            ...
            if (held != null && (held.CompareTag("RawNoodle") || held.gameObject.name.ToLower().Contains("mie kuning")))
            {
                ...
                // Panggil TutorialManager untuk lanjut ke langkah 2
                FindObjectOfType<TutorialManager>()?.OnPlayerAction("mie_dimasak");
